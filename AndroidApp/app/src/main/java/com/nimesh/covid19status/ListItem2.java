...
public class ListItem2 {
   ...
   /* public ListItem2(String lastUpdated, String locTotalCases, String locNewCases, String locHospitalized, String locDeaths, String locRecovered, String gloTotalCases, String gloNewCases, String gloDeaths, String gloRecovered) {
    ...
    public ListItem2(String lastUpdated, String gloTotalCases, String gloNewCases, String gloDeaths, String gloRecovered) {
        this.lastUpdated = lastUpdated;
        this.gloTotalCases = gloTotalCases;
        this.gloNewCases = gloNewCases;
        this.gloDeaths = gloDeaths;
